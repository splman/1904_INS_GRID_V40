...
/**
 * Created by splann on 2016-07-14.
 */
public class PreparedStatementDecorator extends StatementLogger implements PreparedStatement {
    private PreparedStatement preparedStatement;

    public PreparedStatementDecorator(PreparedStatement preparedStatement, String str)
    {
